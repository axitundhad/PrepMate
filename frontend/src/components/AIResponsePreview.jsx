  ...
  return (
    <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
      <div className="flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-200">
        ...
        <button onClick={copyCode} className="text-gray-500 cursor-pointer hover:text-gray-700 focus:outline-none relative group" aria-label="Copy Code">
          {copied ? (
      ...
      <SyntaxHighlighter
        language={language}
        style={oneLight}
        customStyle={{fontSize: 12.5, margin:0, padding:'1rem', background:'transperant'}}
        >
            {code}
        </SyntaxHighlighter>
    </div>
